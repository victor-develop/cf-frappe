...
async function parseDeskCustomField(request: Request): Promise<ParsedDeskCustomField> {
  ...
  return {
    ...
    field: {
      ...
      ...(form.has("printHide") ? { printHide: true } : {}),
      ...(form.has("printHideIfNoValue") ? { printHideIfNoValue: true } : {}),
...
async function parseDeskFieldPropertyOverride(request: Request): Promise<ParsedDeskFieldPropertyOverride> {
  ...
  const overrides = {
    ...
    ...(hiddenDependsOn === undefined ? {} : { hiddenDependsOn }),
    ...optionalBooleanProperty(form, "printHide", "printHide", "Print hide"),
    ...optionalBooleanProperty(form, "printHideIfNoValue", "printHideIfNoValue", "Print hide if no value"),
