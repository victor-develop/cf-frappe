...
- Centralized upload completion document-command intent selection in file policy so direct and multipart completion share the same tested clean-versus-infected event input boundary.
