...
- Centralized bulk delete entry command shaping in file policy so bulk delete no longer composes per-file actor, tenant, metadata, or expected-version inline.
