...
| Reports | Report DocType/query reports | metadata-defined report columns, typed filters, row ordering, summaries, charts, saved definitions, CSV exports, HTTP report-builder API, and Desk pages |
