...
- Generated Desk UI now covers basic list/form/report/print pages. Report builder, custom print templates, letterheads, richer admin tools, saved filters, grouped summaries, charts, and client scripting are not implemented.
