...
| Realtime notifications | `publish_realtime`/Socket.IO | document commit events over Durable Object WebSocket topics with tenant, DocType, and document fan-out plus redacted user-recipient notifications and basic presence snapshots |
...
- Realtime notifications now have Durable Object WebSocket tenant, DocType, and document topics plus redacted user-recipient notifications and basic presence snapshots with Desk client helpers, but richer presence, richer Desk consumption, and durable replay are not implemented.
