...
| Migrations | patches and schema migrations | D1 migration plans, rendered SQL bundles, applied checksum journal, and app-declared data patches with applied journals plus admin apply APIs |
