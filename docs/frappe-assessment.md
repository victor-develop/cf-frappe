...
| Realtime notifications | `publish_realtime`/Socket.IO | document commit events over Durable Object topics with tenant, DocType, and document fan-out plus redacted user-recipient notifications, permissioned presence snapshots, generated Desk presence panels, and bounded durable replay |
...
- Realtime notifications now have Durable Object tenant, DocType, document, and user topics plus redacted user-recipient notifications, permissioned presence snapshots through HTTP, Desk client helpers, generated Desk document presence panels, and bounded durable replay, but live collaborative editing UI is not implemented.
