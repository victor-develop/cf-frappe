...
| Realtime notifications | `publish_realtime`/Socket.IO | document commit events over Durable Object topics with tenant, DocType, and document fan-out plus redacted user-recipient notifications, permissioned presence snapshots, and bounded durable replay |
...
- Realtime notifications now have Durable Object tenant, DocType, document, and user topics plus redacted user-recipient notifications, permissioned presence snapshots through HTTP and Desk client helpers, and bounded durable replay, but richer collaboration-oriented realtime UI is not implemented.
