...
| Custom fields | Custom Field / Customize Form | event-sourced tenant custom field overlays folded into base DocType metadata by `CustomFieldService` |
