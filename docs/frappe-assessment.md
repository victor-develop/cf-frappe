...
| Reports | Report DocType/query reports | metadata-defined report columns, typed filters, row ordering, summaries, drilldown charts, saved definitions, CSV exports, HTTP/Desk report-builder APIs, and Desk pages |
