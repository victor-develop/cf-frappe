...
- metadata-defined print formats with reusable letterheads, field sections, HTML templates with escaped substitutions, DocField print-hide enforcement, HTTP/browser/CLI metadata inspection, remote HTML/PDF downloads, and an optional Cloudflare Browser Rendering PDF adapter
