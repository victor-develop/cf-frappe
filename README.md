...
- metadata-defined Website Themes with safe design tokens, active-theme selection through Website Settings, generated metadata APIs, Desk browser helpers, remote CLI reads, and themed Web Page rendering without raw CSS injection
...
| Website Theme | metadata-defined safe design tokens selected from Website Settings and applied to generated Web Page rendering, with metadata API and remote CLI reads |
