...
- metadata-defined Website Settings for manifest-owned site title, homepage route, and role-filtered navigation that can reference Web Pages, Web Forms, or safe links and renders across public Web Page/Web View/Web Form HTML, with generated metadata API, `/` homepage redirect, and remote CLI reads
...
| Website Settings | metadata-defined site title, homepage route, and role-filtered navigation that references Web Pages, Web Forms, or safe links, renders across public Web Page/Web View/Web Form HTML, and is exposed through metadata API, `/` redirect, and remote CLI reads |
