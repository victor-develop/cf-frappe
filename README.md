...
- installable `cf-frappe init` starter scaffold plus `cf-frappe install` app-registry wiring for new Cloudflare apps
...
| App starter | `cf-frappe init` scaffold with Worker, D1, Durable Object, signed-session wiring, and `cf-frappe install` registry wiring |
