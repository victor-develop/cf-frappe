...
- event-sourced user accounts with optional role-catalog validation, Web Crypto password hashing, signed-cookie login/logout/me APIs, recovery-token flows, and generated Desk administration
...
| Users/login | event-sourced account streams, PBKDF2 password hashing, signed-cookie auth routes, and recovery tokens |
