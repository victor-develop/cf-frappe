...
- metadata-configured list columns, default filters, saved user filters, operator-aware filter controls, filter-builder metadata, ordering, and page size
...
| Desk list/forms | generated `/desk` pages, list/form layouts, columns, saved filters, filters, and ordering from DocType metadata |
