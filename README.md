...
| Dashboards | metadata-defined Desk number and chart cards backed by document counts, document aggregates, report summaries, report charts, and value-driven indicators |
