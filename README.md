...
- event-sourced saved report definitions for per-user report-builder presets
...
| Reports | metadata-defined report columns, typed filters, row ordering, summaries, ordered/colored charts, saved definitions, API, and Desk pages |
