...
| Print formats | metadata-defined printable document pages, letterheads, escaped templates, event-sourced tenant print defaults with Desk/browser/CLI administration, and optional Browser Rendering PDF output |
