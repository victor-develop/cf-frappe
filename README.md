...
- permissioned document timelines, comments, and assignments derived from append-only event streams
...
| Audit trail | permissioned document timelines, comments, and assignments from immutable events |
