...
- metadata-defined Web Views for Website-Generator-style public filtered, ordered, paginated list/detail pages over permissioned projections, with canonical nested route/published fields, generated JSON routes and themed HTML routes, Desk browser helpers, and remote CLI reads
...
| Website Generator / Web View Pages | metadata-defined themed public filtered, ordered, paginated list/detail pages with canonical nested route and published fields, rendered from permissioned `QueryService` projection reads without a second content store |
