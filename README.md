...
- Cloudflare Queue/Cron background job primitives with event-sourced runtime schedule overrides
...
| Background jobs | `JobRegistry`, Queue producers/consumers, Cron dispatch, and event-sourced schedule overrides |
