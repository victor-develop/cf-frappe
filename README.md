...
- metadata-defined Website Settings for manifest-owned site title, homepage route, and role-filtered navigation rendered across public Web Page/Web View HTML, with generated metadata API, `/` homepage redirect, and remote CLI reads
- metadata-defined Website Themes with safe design tokens, active-theme selection through Website Settings, generated metadata APIs, Desk browser helpers, remote CLI reads, and themed Web Page/Web View rendering without raw CSS injection
...
| Website Settings | metadata-defined site title, homepage route, and role-filtered navigation that references Web Pages or safe links, renders across public Web Page/Web View HTML, and is exposed through metadata API, `/` redirect, and remote CLI reads |
| Website Theme | metadata-defined safe design tokens selected from Website Settings and applied to generated Web Page and Web View rendering, with metadata API and remote CLI reads |
