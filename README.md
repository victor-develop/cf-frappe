...
- R2-backed file attachments with event-sourced `File` metadata, metadata updates, storage-level multipart upload primitives, bounded bulk metadata/delete workflows, generated Desk record attachment panels, and filtered file manager workflows
...
| File attachments | `File` DocType metadata plus R2 object storage, metadata updates, direct upload reservation/finalization, storage-level multipart upload primitives, scan hooks, generated Desk record attachment panels, and filtered file manager |
