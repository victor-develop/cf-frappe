...
| Reports | metadata-defined and custom row-provider reports, typed filters, row ordering, summaries, ordered/colored drilldown charts, saved definitions, HTTP/Desk report-builder APIs, Desk pages, and remote CLI metadata/run/CSV export commands |
