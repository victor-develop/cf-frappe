...
- metadata-defined Web Forms with whitelisted public submission fields, published filtering, optional safe public routes and success URLs, generated name-based metadata routes and route-or-name themed HTML routes, route-aware Desk browser helpers, and remote CLI submit commands over the same document command boundary
