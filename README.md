...
- event-sourced document delivery outbox for durable notification, realtime, and email after-commit intents, with idempotent enqueue, claim, retry, and delivery markers
