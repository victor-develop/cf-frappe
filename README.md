...
- R2-backed file attachments with event-sourced `File` metadata, metadata updates, and Desk file manager workflows
...
| File attachments | `File` DocType metadata plus R2 object storage, metadata updates, and generated Desk file manager |
