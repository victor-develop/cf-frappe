...
- metadata-defined Web Views for Website-Generator-style public list/detail pages over permissioned projections, with route/published fields, generated JSON/HTML routes, Desk browser helpers, and remote CLI reads
