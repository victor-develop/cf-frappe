...
```ts
import { createRegistryFromApps, defineApp, defineClientScript, defineDocType, definePrintFormat, defineReport, defineWebForm, fileDocType } from "cf-frappe";
