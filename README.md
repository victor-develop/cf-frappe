...
- metadata-defined Web Forms with whitelisted public submission fields, generated metadata routes and themed HTML routes, Desk browser helpers, and remote CLI submit commands over the same document command boundary
...
| Web Forms | metadata-defined themed submission forms that validate fields against DocType metadata, expose only declared writable fields, and create documents through `DocumentService` with HTTP, public HTML, browser-helper, and remote CLI surfaces |
